...
describe('TonAddress', () => {
    const TEST_ADDRESSES = {
        MAINNET: {
            ...
            FRIENDLY_NON_BOUNCEABLE:
                'UQD4FPq-PRDieyQKkizFTRK2YGABRYUlGGYo1FyZ0Wwgpl5M',
        ...
        INVALID: {
            ...
            WRONG_WORKCHAIN:
                '1:f814fabe3d10e27b240a922cc54d12b6606001458525186628d45c99d16c20a6'
        }
    }
    ...
    describe('Address Creation', () => {
        ...
        it('should create address from raw format', () => {
            const hash = Buffer.from(
                'f814fabe3d10e27b240a922cc54d12b6606001458525186628d45c99d16c20a6',
                'hex'
            )
    ...
    describe('AddressLike Interface', () => {
        ...
        it('should implement equal()', () => {
            const same = TonAddress.fromString(
                TEST_ADDRESSES.MAINNET.FRIENDLY_BOUNCEABLE
            )
    ...
    describe('Address Factory Integration', () => {
        ...
        it('should create TON address from complement via factory', () => {
            ...
            const originalAddress = TonAddress.fromString(
                TEST_ADDRESSES.MAINNET.FRIENDLY_BOUNCEABLE
            )
